type
  TSubMenuAction=class(TCustomSubMenuAction)
  private
   FOnPopulateSubMenu  :TPopulateSubMenuEvent;
  ...
  public
   procedure PopulateSubMenu(AParent: TMenuItem);
   ...
   class destructor Destroy;
   property OnPopulateSubMenu: TPopulateSubMenuEvent;
