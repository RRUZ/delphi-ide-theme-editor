type
  ...
  protected
   ...
   FResizing           :Boolean;
   FControlHeightIndexes::TCustomActionDockBar.:1;
   ...
   function GetActionControl(const Index: Integer): TCustomActionControl;
  public
   ...
   function CreateControl(AnItem: TActionClientItem): TCustomActionControl;
   function DesignWndProc(var Message: TMessage): Boolean;
   procedure DoDropCategory(Source: TCategoryDragObject; const X: Integer; const Y: Integer);
  ...
  published
   ...
   property AllowHiding: Boolean;
   property Anchors: TAnchors;
   property AnimateDuration: Integer;
   property AnimationStyle: TAnimationStyle;
   property AutoFocus: Boolean;
   property BiDiMode: TBiDiMode;
   property Caption: TCaption;
